				...
				<!-- Menu -->
					<nav id="menu">
						...
						<ul>
							...
							<li><a href="/registerView">회원가입</a></li>
							<li><a href="/">인형샵</a></li>
			...
			<script>
				$(function(){
			        function initDisplay(){
			            var windowX = $("body").outerWidth(true);
			            var windowY = $("body").outerHeight(true);
			            var popupX = $("#popup").outerWidth();
			            var popupY = $("#popup").outerHeight(true);
			            $('#popup').css("top","0px");
			            $('#popup').css("left",windowX/2-popupX/2);
			        }
